...
import me.omico.dehell.internal.defaultDehellDependencyAggregatorOutputFile
import me.omico.dehell.internal.services.DehellDependencyService
import me.omico.dehell.internal.tasks.DehellDependencyAggregator.Companion.NAME
...
internal abstract class DehellDependencyAggregator : DehellDependencyTask() {
    ...
    fun Project.configureDehellDependencyAggregator(
        ...
        dehellExtension.dependencyAggregatorOutputFile.orNull
            ?.let(outputFileProperty::convention)
            ?: outputFileProperty.convention(defaultDehellDependencyAggregatorOutputFile)
    }

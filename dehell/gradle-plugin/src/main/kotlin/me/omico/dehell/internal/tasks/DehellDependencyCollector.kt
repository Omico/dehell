...
import me.omico.dehell.internal.defaultDehellDependencyCollectorOutputFile
import me.omico.dehell.internal.services.DehellDependencyService
import me.omico.dehell.internal.tasks.DehellDependencyCollector.Companion.NAME
...
internal abstract class DehellDependencyCollector : DehellDependencyTask() {
    ...
    fun Project.configureDehellDependencyCollector(
        ...
        dehellExtension.dependencyCollectorOutputFile.orNull
            ?.let(outputFileProperty::convention)
            ?: outputFileProperty.convention(defaultDehellDependencyCollectorOutputFile)
    }
